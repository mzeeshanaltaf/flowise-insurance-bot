...
faq_data = {
        'What this Application is about?':
            '<p>A web app that let you Upload your insurance documents and ask questions. Get answers, insights, '
            'and clarity on your coverage. ... .</p>',
        'Which technologies are used by this application?':
            ...
            <ul>
              ...
              <li>Flowise -- AI related workflows</li>
              <li>Pinecone -- Vector DB for RAG</li>
            </ul>
            """,
        'I want to make modification in the application. Can I get the application source code?':
            ...
            '<a href="https://github.com/mzeeshanaltaf/flowise-insurance-bot">GitHub</a></p>',
